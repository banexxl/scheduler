...
CREATE INDEX idx_tenant_subscriptions_polar_customer_id
  ON public.tenant_subscriptions (polar_customer_id);

CREATE INDEX idx_tenant_subscriptions_polar_product_id
  ON public.tenant_subscriptions (polar_product_id);

CREATE INDEX idx_tenant_subscriptions_polar_price_id
  ON public.tenant_subscriptions (polar_price_id)
  WHERE polar_price_id IS NOT NULL;

CREATE INDEX idx_tenant_subscriptions_tenant_access_state
...
CREATE INDEX idx_tenant_subscriptions_tenant_period_end
  ON public.tenant_subscriptions (tenant_id, current_period_end DESC);

CREATE INDEX idx_tenant_subscriptions_access_period_end
  ON public.tenant_subscriptions (access_state, current_period_end DESC);

CREATE INDEX idx_tenant_subscriptions_sync_status_last_synced
