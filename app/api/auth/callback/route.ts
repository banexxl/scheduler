 ...
 * Supports authorization code exchange (recovery links, OAuth).
 *
 * Team invitations no longer flow through here — Supabase native invite links
 * redirect to `/api/auth/accept-invite`, which applies the membership + role.
 *
